...
png(file = file.path("analysis-multiple-imputation", "formatted-output", "primary_study_day_linear.png"), width = 6, height = 6, units = "in", res = 600)

plot(1:8, fit_pooled_causal[-c(1:2),]$Estimate, type = "o", lwd = 1, ylim = c(-1,1), xlab = "Day", ylab = "Treatment Effect")
lines(1:8, fit_pooled_causal[-c(1:2),]$LCL90, type = "o", lty = 2, lwd = 1)
lines(1:8, fit_pooled_causal[-c(1:2),]$UCL90, type = "o", lty = 2, lwd = 1)
