...
all_est <- matrix(rep(NA, .__total_imputed_datasets * 48), nrow = .__total_imputed_datasets, ncol = 48)
all_var <- matrix(rep(NA, .__total_imputed_datasets * 48), nrow = .__total_imputed_datasets, ncol = 48)
...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_no_prompt_by_dp.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_no_prompt_by_dp.rds"))
...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_high_effort_prompt_by_dp.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_high_effort_prompt_by_dp.rds"))
...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_est_low_effort_prompt_by_dp.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "replicates_var_low_effort_prompt_by_dp.rds"))
