...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_est_no_prompt_by_prior_self_efficacy.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_var_no_prompt_by_prior_self_efficacy.rds"))
...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_est_high_effort_prompt_by_prior_self_efficacy.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_var_high_effort_prompt_by_prior_self_efficacy.rds"))
...
saveRDS(all_est, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_est_low_effort_prompt_by_prior_self_efficacy.rds"))
saveRDS(all_var, file = file.path(path_multiple_imputation_pipeline_data, "mi-analysis-results", "mi_var_low_effort_prompt_by_prior_self_efficacy.rds"))
